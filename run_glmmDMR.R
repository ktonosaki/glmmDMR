...
opt_list <- list(
  ...
  make_option("--family", type="character", default="binom", help="model family: binom or beta [default %default]"),
  make_option("--mode", type="character", default="aggregate", help="aggregate (window-sum per sample) or site (site-level) [default %default]"),
